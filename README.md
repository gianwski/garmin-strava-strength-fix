...
**Open the app: https://<your-github-user>.github.io/garmin-strava-strength-fix/**
...
1. In Garmin Connect, open the activity → ⚙ → **Export Original** (.zip).
   Optional: fix the exercises there first and also **Export to CSV**.
